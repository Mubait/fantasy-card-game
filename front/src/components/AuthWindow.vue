    ...
    <div class="absolute w-full h-3/4 bg-gradient-to-b from-blue-950/80 to-black/80 flex flex-col justify-center rounded-lg">
      ...
      <div class="mx-10">
        <div class="grid gap-4">
          ...
          <input v-model="emailInput" class="bg-stone-950 text-gray-400 h-8 rounded-md text-sm pl-4 pb-1 w-full" placeholder="Имя@хост.ru"/>
          <p class="text-gray-50 text-xl font-sans">{{ $t('authPage.password') }}</p>
          <input v-model="passwordInput" type="password" class="bg-stone-950 text-gray-400 h-8 rounded-md text-sm pl-4 pb-1 w-full" placeholder="Пароль"/>
        </div>
